        ...
        reply_markup=InlineKeyboardMarkup([
                [
                    InlineKeyboardButton(
                        "➕ Qrupa əlavə et", url=f"https://t.me/{BOT_USERNAME}?startgroup=true")],
                [
                    InlineKeyboardButton(
                    ...
                    InlineKeyboardButton(
                        "🖥 Rəsmi WebSayt", url=f"https://groupmuzik.tk")
                ]
            ]
        ),
...
async def ghelp(_, message: Message):
    await message.reply_text(
        f"""**🙋‍♀️ Salam mən telegram qruplarında səsli söhbətdə mahnı səsləndirə bilərəm**""",
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Kömək", url=f"https://t.me/{BOT_USERNAME}?start")]]),
    )
