...
async def addchannel(client, message):
    ...
    try:
        ...
        await USER.send_message(message.chat.id, "Asistan Qrupa qatıldı!")
    except UserAlreadyParticipant:
        await message.reply_text(
            "<b>Asistan artıq qrupdadı</b>",
        )
...
async def rem(USER, message):
    try:
        ...
        await message.reply_text(
            f"<b>Asistan qrupunuzdan ayrıla bilmədi. Flood ola bilər"
            "\n\nAdminlərdən biri qrupdan ata bilər</b>",
        )
        return
    
@Client.on_message(filters.command(["userleaveall"]))
...
@Client.on_message(filters.command(["userjoinchannel","userjoinc"]) & ~filters.private & ~filters.bot)
@authorized_users_only
@errors
